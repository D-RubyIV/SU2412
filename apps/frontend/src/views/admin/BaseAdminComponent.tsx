              ...
              <Link
                ...
                className={`${
                  location.pathname.endsWith(item.url)
                    ? "bg-gray-100 opacity-70 rounded-s-md"
                    : ""
                } my-2 py-1 px-1  border-b-gray-200 text-sm text-gray-900`}
              >
                <div className="gap-2 flex">
                  <span>{item.icon}</span>
                  <span
                    className={`${
                      isOpen ? "text-left" : "hidden"
                    } text-[12px] transition-all ease-in-out`}
                  >
                    {item.name}
                  </span>
                </div>
